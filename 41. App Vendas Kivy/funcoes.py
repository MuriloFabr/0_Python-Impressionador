...
class BannerVenda(GridLayout):
    ...
    def __init__(self, **kwargs): #está sobrescrevendo a inicialização da Classe BannerVenda com outros argumentos
        super().__init__() #puxa as propriedades de GridLayout do BannerVenda logo a inicialização
        self.rows = 1
        ...
        # kwargs = {"cliente": "mundial", "foto_cliente": "mundial.png"} -> key words arguments. É o dicionário que você está passando na hora de criar a classe pela função Python
